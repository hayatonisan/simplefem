"""
Kratos SmallDisplacementElement2D6N cantilever
"""
import sys, os, time
...
with open("ProjectParameters_SmallDisplacementElement2D6N.json") as f:
...
print(f"KRATOS_SmallDisplacementElement2D6N_TIP_UY={uy:.8f}")
...
with open(os.path.join(results_dir, "kratos_SmallDisplacementElement2D6N_uy.txt"), "w") as f:
    f.write(f"{uy:.15E}\n")

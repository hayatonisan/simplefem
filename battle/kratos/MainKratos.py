"""
Kratos SmallDisplacementElement2D4N cantilever (plane strain)
SIMPLEFEM quad4 と同じメッシュ・荷重
"""
import sys, os, time
...
print(f"KRATOS_QUAD_TIP_UY={uy:.8f}")
...
with open(os.path.join(results_dir, "kratos_uy.txt"), "w") as f:
    f.write(f"{uy:.15E}\n")

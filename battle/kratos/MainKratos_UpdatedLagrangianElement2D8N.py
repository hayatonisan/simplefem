"""
Kratos UpdatedLagrangianElement2D8N cantilever
"""
import sys, os, time
...
with open("ProjectParameters_UpdatedLagrangianElement2D8N.json") as f:
...
print(f"KRATOS_UpL_8N_TIP_UY={uy:.8f}")
...
with open(os.path.join(results_dir, "kratos_UpdatedLagrangianElement2D8N_uy.txt"), "w") as f:
    f.write(f"{uy:.15E}\n")

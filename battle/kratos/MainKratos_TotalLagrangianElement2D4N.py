"""
Kratos TotalLagrangianElement2D4N cantilever
"""
import sys, os, time
...
with open("ProjectParameters_TotalLagrangianElement2D4N.json") as f:
...
print(f"KRATOS_ToL_4N_TIP_UY={uy:.8f}")
...
fname = "TotalLagrangianElement2D4N".lower().replace("element","").replace("2d","").replace("n","n")
with open(os.path.join(results_dir, "kratos_TotalLagrangianElement2D4N_uy.txt"), "w") as f:
    f.write(f"{uy:.15E}\n")

"""
Kratos SmallDisplacementElement2D3N cantilever
CST 三角形 (定ひずみ三角形), 55節点 / 80要素
"""
import sys, os, time
...
with open("ProjectParameters_SmallDisplacementElement2D3N.json") as f:
...
print(f"KRATOS_3N_TIP_UY={uy:.8f}")
...
with open(os.path.join(results_dir, "kratos_SmallDisplacementElement2D3N_uy.txt"), "w") as f:
    f.write(f"{uy:.15E}\n")
